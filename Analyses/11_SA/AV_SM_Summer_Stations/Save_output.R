...
write.table(output_5000, file="/storage/group/pches/default/users/aqa6478/aqa6478/WBM/Codes/SA/AV_SM_Summer_Stations/data/model_output.txt", row.names=FALSE, col.names=FALSE)
