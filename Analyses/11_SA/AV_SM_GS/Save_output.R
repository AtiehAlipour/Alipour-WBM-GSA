...
for(i in 1:5000){
  ...
  output_5000[i]<- mean(SM_Output[indices,])}
...
write.table(output_5000, file="/storage/group/pches/default/users/aqa6478/aqa6478/WBM/Codes/SA/AV_SM_GS/data/model_output.txt", row.names=FALSE, col.names=FALSE)
