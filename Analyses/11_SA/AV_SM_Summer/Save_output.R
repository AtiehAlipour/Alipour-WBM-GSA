...
for(i in 1:5000){
  ...
  indices <- which(format(date_sequence, "%m") %in% c("06", "07", "08"))
...
write.table(output_5000, file="/storage/group/pches/default/users/aqa6478/aqa6478/WBM/Codes/SA/AV_SM_Summer/data/model_output.txt", row.names=FALSE, col.names=FALSE)
